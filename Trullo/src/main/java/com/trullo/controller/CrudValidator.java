...
public interface CrudValidator {
    ...
    default void validateId(Long id) {
        if (id == null) {
            throw new ValidationException("id no puede ser nulo");
        }
    }
    ...
    default void requireText(String value, String campo) {
        if (value == null || value.isBlank()) {
            throw new ValidationException(campo + " no puede ser nulo ni vacio");
        }
    }
    ...
    default void requireNonNull(Object value, String campo) {
        if (value == null) {
            throw new ValidationException(campo + " no puede ser nulo");
        }
    }
}
